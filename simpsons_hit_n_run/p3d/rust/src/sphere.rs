#![allow(unused)]
use crate::chunks::Cylinder;
use crate::utils::{Matrix3f, Vec3f};
...
pub fn cylinder_points(cylinder: &Cylinder, wires: u32) -> Vec<Vec<Vec3f>> {
    let Cylinder {
        position: p,
        axis: a,
        radius: r,
    ...
    let mut wire = 0f32;
    let mut vt = Vec3f::new();
    let mut vb = Vec3f::new();
